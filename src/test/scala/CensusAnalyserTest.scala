import com.bridgelabz.indiancensusanalser.{CensusAnalyser, CensusAnalyzerExceptionEnums, CensusLoader, Country, IndiaCensusDTO}
...
class CensusAnalyserTest extends FunSuite {
  ...
  var objCensus = new CensusAnalyser()
